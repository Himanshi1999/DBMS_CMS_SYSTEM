...
def mainscreen():
    ...
    conn.close()
    #heading
    mswelcome1 = Label(ms,text='Welcome to',pady=20)
...
def reqcourier():
    ...
    Label(home, text = 'National Institute Of Technology, Hamirpur, 177005', font = ('arial', 13)).place(relx = .25, rely = .55, anchor = W)
...
def adminpage():
    ...
    #headings
    wel1 = Label(x, text = 'Welcome to', font = ('Sans-serif', 24, 'bold'),pady=20)
    ...
    #homepage icons
    #create
    createimg = Image.open("add.png")
    createrend = ImageTk.PhotoImage(createimg)
    #read
    readimg = Image.open("view.png")
    readrend = ImageTk.PhotoImage(readimg)
    #Update
    updateimg = Image.open("delupdate.png")
    updaterend = ImageTk.PhotoImage(updateimg)
    #delete
    deleteimg = Image.open("delete.png")
    deleterend = ImageTk.PhotoImage(deleteimg)
    #create requests
    crimg = Label(image = createrend)
    crimg.image = createrend
    #read
    rdimg = Label(image = readrend)
    rdimg.image = readrend
    #update
    upimg = Label(image = updaterend)
    upimg.image = updaterend
    #delete
    deimg = Label(image = deleterend)
    deimg.image = deleterend
    #alignment of icons
    crimg.place(relx = .20, rely = .45, anchor = CENTER)
    rdimg.place(relx = .40, rely = .45, anchor = CENTER)
    upimg.place(relx = .60, rely = .45, anchor = CENTER)
    deimg.place(relx = .80, rely = .45, anchor = CENTER)
    #tools
    Button(x, text = 'Create', font = ('arial', 13), bd = 3, command = lambda: createpage(x), width = 15).place(relx = .20, rely = .55, anchor = CENTER)
    Button(x, text = 'View', font = ('arial', 13), bd = 3, command = lambda: viewpage(x), width = 15).place(relx = .40, rely = .55, anchor = CENTER)
    Button(x, text = 'Update', font = ('arial', 13), bd = 3, command = lambda:updatepage(x), width = 15).place(relx = .60, rely = .55, anchor = CENTER)
    Button(x, text = 'Delete', font = ('arial', 13), bd = 3, command = lambda: deletepage(x), width = 15).place(relx = .80, rely = .55, anchor = CENTER)
    x.mainloop()
def adminback(win):
    win.destroy()
    adminpage()
...
def createpage(win):
    win.destroy()
    ce = Tk()
    ce.title("Welcome to CMS")
    ce.attributes('-fullscreen', True)
    #headings
    wel1 = Label(ce, text = 'Welcome to', font = ('Sans-serif', 24, 'bold'),pady=20)
    wel2 = Label(ce, text = 'Courier Management System', font = ('Script-typeface', 32, 'bold'))
    log = Label(ce, text = 'Create Records', font = ('Script-typeface', 30, 'bold'),pady=20)
    wel1.pack()
    wel2.pack()
    log.pack()
    sidebackadmin(ce)
    ...
    #tools
    Button(ce, text = 'Create Feedbacks', font = ('arial', 13), bd = 3, command = lambda: cefeed(ce), width = 15).place(relx = .25, rely = .55, anchor = CENTER)
    Button(ce, text = 'Create Courier Requests', font = ('arial', 13), bd = 3, command = lambda: cereq(ce)).place(relx = .50, rely = .55, anchor = CENTER)
    Button(ce, text = 'Create Users', font = ('arial', 13), bd = 3, command = lambda: ceusers(ce), width = 15).place(relx = .75, rely = .55, anchor = CENTER)
    ce.mainloop()
def createback(win):
    createpage(win)
def sidebackcreate(window):
    #rhs buttons & icons
    backimg = Image.open("Back.png")
    backrender = ImageTk.PhotoImage(backimg)
    bimg = Button(window, image = backrender, command = lambda: createback(window), bd = 0)
    bimg.image = backrender
    bimg.place(relx = .02, rely = .04)
#create feedbacks
def cefeed(win):
    win.destroy()
    window = Tk()
    window.title('Create Feedbacks')
    window.attributes('-fullscreen', True)
    sidebackcreate(window)
    sideexit(window)
    #feedback
    ...
    aimg.place(relx = .5, rely=.05, anchor = N)
    #admin label
    log = Label(window, text = 'Add Feedback', font = ('Script-typeface', 23, 'bold'))
    log.place(relx = .5, rely = .20, anchor = N)
    #labels and input
    mail = Label(window, text = 'Add Email:', font = ('arial', 14))
    ...
    def checkfeed():
        ...
        if str1 and str2:
            if re.search('[@]', str1) is None:
                ...
                conn.commit()
                conn.close()
                messagebox.showinfo('Success', 'Feedback created successfully.')
                sidebackcreate(window)
        else:
            messagebox.showerror('Failure', 'Please fill the email and Feedback!')

    submit = Button(window, text = 'Add Feedback', command = checkfeed, font = ('Roboto', 13, 'bold'), bd = 3, bg = 'darkblue', fg = 'white')
...
def cereq(win):
    win.destroy()
    window = Tk()
    window.title('Create Courier Requests')
    window.attributes('-fullscreen', True)
    sidebackcreate(window)
    sideexit(window)
    #request img
    ...
    log = Label(window, text = 'Add an Courier Request', font = ('Script-typeface', 23, 'bold'))
    log.place(relx = .5, rely = .25, anchor = N)

    #inputs
    Label(window, text = 'User details:', font = ('arial', 13)).place(relx = .10, rely = .35, anchor = W)
    #username entry
    username1 = StringVar() #for getting username
    uname = Label(window, text = 'Username:', font = ('arial', 14))
    uname.place(relx = .20, rely = .40, anchor = W)
    username = Entry(window, width = 20, bd = 2, font = ('roboto', 13))
    username.place(relx = .35, rely = .40, anchor = CENTER)
    username.focus_set()
    #registration number
    Label(window, text = 'Registration No:', font = ('arial', 14)).place(relx = .47, rely = .40, anchor = W)
    regno = Entry(window, width = 10, bd = 2, font = ('roboto', 13))
    regno.place(relx = .57, rely = .40, anchor = W)
    #mobile number
    ph = Label(window, text = 'Mobile No:', font = ('arial', 14))
    ph.place(relx = .70, rely = .40, anchor = W)
    phone = Entry(window, width = 20, bd = 2, font = ('roboto', 13))
    phone.place(relx = .84, rely = .40, anchor = CENTER)
    #courier details
    Label(window, text = 'Courier details:', font = ('arial', 13)).place(relx = .10, rely = .50, anchor = W)
    #travel from and to
    Label(window, text = 'From:', font = ('arial', 14)).place(relx = .20, rely = .55, anchor = W)
    Label(window, text = 'National Institute of Technology, Hamirpur, 177005', font = ('arial', 13)).place(relx = .25, rely = .55, anchor = W)
    Label(window, text = 'To:', font = ('arial', 14)).place(relx = .55, rely = .55, anchor = W)
    to = Entry(window, width = 50, font = ('roboto', 13), bd = 2)
    to.place(relx = .58, rely = .55, anchor = W)
    #weight
    wgh = Label(window, text = 'Weight (in gms):', font = ('arial', 14))
    wgh.place(relx = .20, rely = .65, anchor = W)
    weight = Entry(window, width = 8, font = ('roboto', 13), bd = 2)
    weight.place(relx = .30, rely = .65, anchor = W)
    #Travel Distance
    dist = Label(window, text = 'Travel Distance (in kms):', font = ('arial', 14))
    dist.place(relx = .40, rely = .65, anchor = W)
    distance = Entry(window, width = 8, font = ('roboto', 13), bd = 2)
    distance.place(relx = .55, rely = .65, anchor = W)
    #Delivery Type
    ...
    deltype.place(relx = .75, rely = .65, anchor = W)
    #cost label
    Label(window, text = 'Estimated Cost:', font = ('arial', 14)).place(relx = .20, rely = .75, anchor = W)
    costlabel = Label(window, text = "", font = ('arial', 14), fg = 'darkblue')
    costlabel.place(relx = .47, rely = .75, anchor = CENTER)
    #consignment number
    cons = Label(window, text = '', font = ('arial', 14), fg = 'darkblue')
    cons.place(relx = .20, rely = .80, anchor = W)
    #cost checker
    #check cost button
    Button(window, text = 'Check cost', bd = 0, font = ('roboto', 12), command = lambda: costcheck(weight, distance, deltype, costlabel)).place(relx = .32, rely = .75, anchor = CENTER)
    #submit chekcer
    def checkreq():
        str1 = username.get()
        str2 = regno.get()
    ...
    #submit button
    Button(window, text = 'Add Request', bd = 3, font = ('roboto', 13, 'bold'), bg = 'darkblue', fg = 'white', command = checkreq, width = 15).place(relx = .55, rely = .87, anchor = CENTER)
    Button(window, text = 'Reset', bd = 3, font = ('roboto', 13, 'bold'), bg = 'darkred', fg = 'white', command = lambda: reqcourierpre(window), width = 10).place(relx = .45, rely = .87, anchor = CENTER)
    window.mainloop()

def ceusers(win):
    win.destroy()
    window = Tk()
    window.title('Create Users')
    window.attributes('-fullscreen', True)
    sidebackcreate(window)
    sideexit(window)
    #user img
    ...
    #create database on tkinter window
    log = Label(window, text = 'Create user to CMS', font = ('Script-typeface', 23, 'bold'))
    log.place(relx = .5, rely = .25, anchor = N)
    sideicons(window)
    ...
    username.focus_set()
    #registration no. entry
    reg = Label(window, text = 'Registration No:', font = ('arial', 14))
    reg.place(relx = .34, rely = .39, anchor = W)
    regno1 = IntVar()
    regno = Entry(window, width = 20, bd = 2, font = ('roboto', 13))
    regno.place(relx = .57, rely = .39, anchor = CENTER)
    #gender
    var = StringVar()
    gender = Label(window, text = 'Gender:', font = ('arial', 14))
    gender.place(relx = .34, rely = .46, anchor = W)
    M = Radiobutton(window, text = 'Male', variable = var, value = 'Male', font = ('verdana pro', 13))
    M.focus_set()
    F = Radiobutton(window, text = 'Female', variable = var, value = 'Female', font = ('verdana pro', 13))
    M.place(relx = .53, rely = .46, anchor = CENTER)
    F.place(relx = .60, rely = .46, anchor = CENTER)
    #mobile number
    ph = Label(window, text = 'Mobile No:', font = ('arial', 14))
    ...
    phone.place(relx = .57, rely = .53, anchor = CENTER)
    #email
    eml = Label(window, text = 'E-mail:', font = ('arial', 14))
    eml.place(relx = .34, rely = .60, anchor = W)
    #phone1 = IntVar()
    email = Entry(window, width = 20, bd = 2, font = ('roboto', 13))
    email.place(relx = .57, rely = .60, anchor = CENTER)
    #password entry
    pass1 = StringVar()
    pswrd1 = Label(window, text = 'Password:', font = ('arial', 14))
    pswrd1.place(relx = .34, rely = .67, anchor = W)
    password1 = Entry(show = "*", width = 20, bd = 2, font = ('roboto', 13))
    password1.place(relx = .57, rely = .67, anchor = CENTER)
    #re-enter password
    pass2 = StringVar()
    pswrd2 = Label(window, text = 'Re-enter Password:', font = ('arial', 14))
    pswrd2.place(relx = .34, rely = .74, anchor = W)
    password2 = Entry(show = "*", width = 20, bd = 2, font = ('roboto', 13))
    password2.place(relx = .57, rely = .74, anchor = CENTER)
    ...
    sideexit(window)
    #submit button
    submit = Button(window, text = 'Submit',  command = checknew, font = ('Roboto', 13, 'bold'), bd = 3, bg = 'darkblue', fg = 'white')
    submit.place(relx = .57, rely = .80, anchor = CENTER)
...
def viewpage(win):
    win.destroy()
    v = Tk()
    v.title("Welcome to CMS")
    v.attributes('-fullscreen', True)
    #headings
    wel1 = Label(v, text = 'Welcome to', font = ('Sans-serif', 24, 'bold'),pady=20)
    wel2 = Label(v, text = 'Courier Management System', font = ('Script-typeface', 32, 'bold'))
    log = Label(v, text = 'View Records', font = ('Script-typeface', 30, 'bold'),pady=20)
    wel1.pack()
    wel2.pack()
    log.pack()
    sidebackadmin(v)
    ...
    usimg.place(relx = .75, rely = .45, anchor = CENTER)
    #tools
    Button(v, text = 'See Feedbacks', font = ('arial', 13), bd = 3, command = lambda: seefeed(v), width = 15).place(relx = .25, rely = .55, anchor = CENTER)
    Button(v, text = 'See Courier Requests', font = ('arial', 13), bd = 3, command = lambda: seereq(v)).place(relx = .50, rely = .55, anchor = CENTER)
    Button(v, text = 'See Users', font = ('arial', 13), bd = 3, command = lambda: seeusers(v), width = 15).place(relx = .75, rely = .55, anchor = CENTER)
    v.mainloop()
def viewback(win):
    viewpage(win)
def sidebackview(window):
    #rhs buttons & icons
    backimg = Image.open("Back.png")
    backrender = ImageTk.PhotoImage(backimg)
    bimg = Button(window, image = backrender, command = lambda: viewback(window), bd = 0)
    bimg.image = backrender
    bimg.place(relx = .02, rely = .04)
#see feedbacks
def seefeed(win):
...
def updatepage(win):
    win.destroy()
    ut = Tk()
    ut.title("Welcome to CMS")
    ut.attributes('-fullscreen', True)
    #headings
    wel1 = Label(ut, text = 'Welcome to', font = ('Sans-serif', 24, 'bold'),pady=20)
    wel2 = Label(ut, text = 'Courier Management System', font = ('Script-typeface', 32, 'bold'))
    log = Label(ut, text = 'Update Records', font = ('Script-typeface', 30, 'bold'),pady=20)
    wel1.pack()
    wel2.pack()
    log.pack()
    sidebackadmin(ut)
    ...
    usimg.place(relx = .75, rely = .45, anchor = CENTER)
    #tools
    Button(ut, text = 'Update Feedbacks', font = ('arial', 13), bd = 3, command = lambda: utfeed(ut), width = 15).place(relx = .25, rely = .55, anchor = CENTER)
    Button(ut, text = 'Update Courier Requests', font = ('arial', 13), bd = 3, command = lambda: utreq(ut)).place(relx = .50, rely = .55, anchor = CENTER)
    Button(ut, text = 'Update Users', font = ('arial', 13), bd = 3, command = lambda: utusers(ut), width = 15).place(relx = .75, rely = .55, anchor = CENTER)
    ut.mainloop()
def updateback(win):
    updatepage(win)
def sidebackupdate(window):
    #rhs buttons & icons
    backimg = Image.open("Back.png")
    backrender = ImageTk.PhotoImage(backimg)
    bimg = Button(window, image = backrender, command = lambda: updateback(window), bd = 0)
    bimg.image = backrender
    bimg.place(relx = .02, rely = .04)
...
def utfeed(win):
    win.destroy()
    window = Tk()
    window.title('Update Feedbacks')
    window.attributes('-fullscreen', True)
    sidebackupdate(window)
    sideexit(window)
    #feedback
    feedimg = Image.open("feed.png")
    feedrend = ImageTk.PhotoImage(feedimg)
    ...
    fdimg.place(relx = .5, rely = .15, anchor = CENTER)
    #feedback database on tkinter
    mail = Label(window, text = 'Enter Email:', font = ('arial', 14))
    mail.place(relx = .35, rely = .35, anchor = W)
    feedmail = Entry(window, width = 25, font = ('arial', 13), bd = 2)
    feedmail.place(relx = .55, rely = .35, anchor = CENTER)
    feedback = Label(window, text = 'Enter Feedback:', font = ('arial', 14))
    feedback.place(relx = .35, rely = .42, anchor = W)
    feed = Entry(window, width = 25, font = ('arial', 13), bd = 2)
    feed.place(relx = .55, rely = .42, anchor = CENTER)
    conn = sq.connect("cmsfeed.db")
    cur = conn.cursor()
    def updatefeed():
        str1 = feedmail.get()
        str2 = feed.get()
        updatefeed = "Update cmsfeed set feedback='%s' where email='%s'" %(str2,str1)
        cur.execute(updatefeed)
        conn.commit()
        messagebox.showinfo("Information","Record Updated")
        feedmail.delete(0,END)
        feed.delete(0,END)
    submit = Button(window, text = 'Update', command = updatefeed, font = ('Roboto', 13, 'bold'), bd = 3, bg = 'darkblue', fg = 'white')
    submit.place(relx = .5, rely = .85, anchor = CENTER)
    window.mainloop()
...
def utreq(win):
    win.destroy()
    window = Tk()
    window.title('Update Courier Requests')
    window.attributes('-fullscreen', True)
    sidebackupdate(window)
    sideexit(window)
    #request img
    ...
    rqimg.image = reqrend
    rqimg.place(relx = .5, rely = .15, anchor = CENTER)
    log = Label(window, text = 'Update an Courier Request', font = ('Script-typeface', 23, 'bold'))
    log.place(relx = .5, rely = .25, anchor = N)
    ...
    deltype.place(relx = .75, rely = .65, anchor = W)
    #consignment Number
    cons = Label(window, text = 'Consignment No:', font = ('arial', 14))
    cons.place(relx = .20, rely = .75, anchor = W)
    consign = Entry(window, width = 8, font = ('roboto', 13), bd = 2)
    consign.place(relx = .31, rely = .75, anchor = W)
    #cost checker
    def checkreq():
        str1 = username.get()
        str2 = regno.get()
        ...
        dk1, dk2, dk3, dk5, dk6, dk8 = 0,0,0,0,0,0
        if str1 and str2 and str3 and str5 and str6 and str8:
            if len(str1) < 6 or len(str1) > 15:
                messagebox.showerror('Failure', 'Username must contain characters between 6 and 20')
                dk1 = 1
            elif re.search('[a-zA-Z]', str2) or len(str2) != 8: # or re.search('[A-Z]', str2):
                ...
                messagebox.showerror('Failure', 'Distance should be at least 4 Kms')
                dk6 = 1
            elif re.search('[a-zA-Z]', str8) or len(str8) != 7: # or re.search('[A-Z]', str2):
                messagebox.showerror('Failure', 'Consignment number should only contain 7 digits!')
                dk8 = 1
            if dk1 == 0 and dk2 == 0 and dk5 == 0 and dk6 == 0 and dk3 == 0 and dk8 == 0:
                #changing data types
                str1 = str(str1)
                str2 = int(str2)
                str3 = int(str3)
                ...
                conn = sq.connect('cmsreq.db')
                #enter user data to database
                updatereq = "Update cmsreq set username ='%s', regno ='%s', mobile='%s', weight = '%s', distance = '%s', deltype ='%s' where consnum ='%s'"%(str1, str2, str3, str5, str6, str7,str8)
                conn.execute(updatereq)
                #commit the changes and close the connection to database
                conn.commit()
                conn.close()
                messagebox.showinfo('Request Updated Successfully', 'Request Updated Successfully.')


    #submit button
    Button(window, text = 'Update Request', bd = 3, font = ('roboto', 13, 'bold'), bg = 'darkblue', fg = 'white', command = checkreq, width = 15).place(relx = .49, rely = .87, anchor = CENTER)
    window.mainloop()

def utusers(win):
    win.destroy()
    window = Tk()
    window.title('Update Users')
    window.attributes('-fullscreen', True)
    sidebackupdate(window)
    sideexit(window)
    #user img
    ...
    usimg.place(relx = .5, rely = .15, anchor = CENTER)
    #create database on tkinter window
    log = Label(window, text = 'Update user in CMS', font = ('Script-typeface', 23, 'bold'))
    log.place(relx = .5, rely = .25, anchor = N)
    sideicons(window)
    ...
    def checknew():
        ...
        if str1 and str2 and str3 and str4 and str5 and str6 and str7:
            ...
            if dk1 == 0 and dk2 == 0 and dk4 == 0 and dk5 == 0 and dk6 == 0 and dk7 == 0:
                ...
                #enter user data to database
                updateuser = "Update cmsuser set regno ='%s', gender='%s', mobile = '%s', email = '%s', password ='%s' where username ='%s'"%(str2, str3, str4, str5,str6,str1)
    ...
    sideexit(window)
    #submit button
    submit = Button(window, text = 'Update',  command = checknew, font = ('Roboto', 13, 'bold'), bd = 3, bg = 'darkblue', fg = 'white')
    submit.place(relx = .49, rely = .80, anchor = CENTER)
...
def deletepage(win):
    win.destroy()
    dl = Tk()
    dl.title("Welcome to CMS")
    dl.attributes('-fullscreen', True)
    #headings
    wel1 = Label(dl, text = 'Welcome to', font = ('Sans-serif', 24, 'bold'),pady=20)
    wel2 = Label(dl, text = 'Courier Management System', font = ('Script-typeface', 32, 'bold'))
    log = Label(dl, text = 'Delete Records', font = ('Script-typeface', 30, 'bold'),pady=20)
    wel1.pack()
    wel2.pack()
    log.pack()
    sidebackadmin(dl)
    ...
    usimg.place(relx = .75, rely = .45, anchor = CENTER)
    #tools
    Button(dl, text = 'Delete Feedbacks', font = ('arial', 13), bd = 3, command = lambda: dlfeed(dl), width = 15).place(relx = .25, rely = .55, anchor = CENTER)
    Button(dl, text = 'Delete Courier Requests', font = ('arial', 13), bd = 3, command = lambda: dlreq(dl)).place(relx = .50, rely = .55, anchor = CENTER)
    Button(dl, text = 'Delete Users', font = ('arial', 13), bd = 3, command = lambda: dlusers(dl), width = 15).place(relx = .75, rely = .55, anchor = CENTER)
    dl.mainloop()
def deleteback(win):
    deletepage(win)
def sidebackdelete(window):
    #rhs buttons & icons
    backimg = Image.open("Back.png")
    backrender = ImageTk.PhotoImage(backimg)
    bimg = Button(window, image = backrender, command = lambda: deleteback(window), bd = 0)
    bimg.image = backrender
    bimg.place(relx = .02, rely = .04)
...
def dlfeed(win):
    win.destroy()
    window = Tk()
    window.title('Delete Feedbacks')
    window.attributes('-fullscreen', True)
    sidebackdelete(window)
    sideexit(window)
    #feedback
    feedimg = Image.open("feed.png")
    feedrend = ImageTk.PhotoImage(feedimg)
    ...
    def deletefeed():
        str = feedmail.get()
        deletefeed = "delete from cmsfeed where email = '%s'" %(str)
        cur.execute(deletefeed)
        conn.commit()
        messagebox.showinfo("Information","Record Deleted")
        feedmail.delete(0,END)
    submit = Button(window, text = 'Delete', command = deletefeed, font = ('Roboto', 13, 'bold'), bd = 3, bg = 'darkblue', fg = 'white')
    submit.place(relx = .5, rely = .85, anchor = CENTER)
    window.mainloop()
...
def dlreq(win):
    win.destroy()
    window = Tk()
    window.title('Delete Courier Requests')
    window.attributes('-fullscreen', True)
    sidebackdelete(window)
    sideexit(window)
    #request img
    ...
    rqimg.image = reqrend
    rqimg.place(relx = .5, rely = .15, anchor = CENTER)
    log = Label(window, text = 'Delete an Courier Request', font = ('Script-typeface', 23, 'bold'))
    log.place(relx = .5, rely = .25, anchor = N)
    #rhs buttons & icons
    sidebackdelete(window)
    sideexit(window)
    ...
    #username entry
    Label(window, text = 'Consignment No:', font = ('arial', 14)).place(relx = .39, rely = .40, anchor = W)
    consign = Entry(window, width = 10, bd = 2, font = ('roboto', 13))
    consign.place(relx = .53, rely = .40, anchor = W)
    def checkreq():
        str2 = consign.get()
        dk2= 0
        if re.search('[a-zA-Z]', str2) or len(str2) != 7: # or re.search('[A-Z]', str2):
            messagebox.showerror('Failure', 'Consignment number should only contain 7 digits!')
            dk2 = 1
        ...
        if dk2 == 0 :
            ...
            conn = sq.connect('cmsreq.db')
            #enter user data to database
            conn.execute("delete from cmsreq where consnum = '%s'" %(str2))
            #commit the changes and close the connection to database
            conn.commit()
            conn.close()
            messagebox.showinfo('Request Deleted Successfully', 'Request Deleted Successfully.')

    #submit button
    Button(window, text = 'Delete Request', bd = 3, font = ('roboto', 13, 'bold'), bg = 'darkblue', fg = 'white', command = checkreq, width = 15).place(relx = .49, rely = .87, anchor = CENTER)
    window.mainloop()
...
def dlusers(win):
    ...
    usimg.place(relx = .5, rely = .15, anchor = CENTER)
    #create database on tkinter window
    log = Label(window, text = 'Delete user from CMS', font = ('Script-typeface', 23, 'bold'))
    log.place(relx = .5, rely = .19, anchor = N)
    sideicons(window)
    #register icon
    userimg = Image.open("newuser.png")
    ...
    def checknew():
        ...
        if dk1 == 0:
            ...
            #check for username
            c = conn.cursor()
            c.execute("delete from cmsuser where username = '%s'" %(str1))
            conn.commit()
            conn.close()
            messagebox.showinfo('Deletion Successful', 'User Deleted.')
            regno.delete(0,END)
    #submit button
    submit = Button(window, text = 'Delete',  command = checknew, font = ('Roboto', 13, 'bold'), bd = 3, bg = 'darkblue', fg = 'white')
    submit.place(relx = .49, rely = .80, anchor = CENTER)
    sidebackdelete(window)
    sideexit(window)
    window.mainloop()
